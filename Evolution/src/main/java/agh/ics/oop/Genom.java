...
public class Genom {
    ...
    public List<Integer> genes; // public? co może pójść nie tak?

    //konstruktor gdy podano mi rodzicow
    public Genom(Animal a1, Animal a2, int len, int minM, int maxM, boolean isCrazy, boolean randMut) { // nieczytelne nezwy minM i maxM
        this.genomLen = len;
        ...
        if (randMut) { // if nie jest najlepszym rozwiązaniem
    ...
    public int giveNextGen() {  // getNextGene
